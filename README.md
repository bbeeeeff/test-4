...
- Weekly summary calculates the total for each week in the month.
- Monthly summary totals all purchases for the current month.
...
## Tests
This project has no automated tests. Running `npm test` will output a placeholder message.
